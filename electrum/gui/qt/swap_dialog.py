...
class SwapDialog(WindowModalDialog):
    ...
    def __init__(self, window: 'ElectrumWindow', is_reverse=None, recv_amount_sat=None, channels=None):
        ...
        self.send_amount_e = SATAmountEdit(self.window.get_decimal_point)
        self.recv_amount_e = SATAmountEdit(self.window.get_decimal_point)
    ...
    def update(self):
        ...
        send_icon = read_QIcon("lightning.png" if self.is_reverse else "satori.png")
        self.send_label.setIcon(send_icon)
        recv_icon = read_QIcon("lightning.png" if not self.is_reverse else "satori.png")
