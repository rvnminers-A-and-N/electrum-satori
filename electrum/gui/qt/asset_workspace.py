...
from electrum.satori import TOTAL_COIN_SUPPLY_LIMIT_IN_BTC, base_decode, base_encode, address_to_script, COIN
...
class AssetCreateWorkspace(QWidget):
    def __init__(self, parent, create_asset_callable):
        ...
        self.cost_label = QLabel('Cost: {} SAT'.format(constants.net.BURN_AMOUNTS.IssueAssetBurnAmount))
        ...
        def on_type_click(clayout_obj):
            ...
            if i == 0:
                self.cost_label.setText('Cost: {} SAT'.format(constants.net.BURN_AMOUNTS.IssueAssetBurnAmount))
            elif i == 1:
                self.cost_label.setText('Cost: {} SAT'.format(constants.net.BURN_AMOUNTS.IssueSubAssetBurnAmount))
            elif i == 2:
                self.cost_label.setText('Cost: {} SAT'.format(constants.net.BURN_AMOUNTS.IssueUniqueAssetBurnAmount))
        ...
        top_layout.addWidget(HelpButton("https://hans-schmidt.github.io/mastering_satori/current_tech_docs/satori_overview_of_assets.html"))
...
class AssetReissueWorkspace(QWidget):
    def __init__(self, parent, reissue_asset_callable):
        ...
        self.cost_label = QLabel('Cost: {} SAT'.format(constants.net.BURN_AMOUNTS.ReissueAssetBurnAmount))
