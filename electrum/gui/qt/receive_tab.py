...
from electrum.satori import is_address
...
from .amountedit import AmountEdit, SATAmountEdit, SizedFreezableLineEdit
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        self.receive_amount_e = SATAmountEdit(self.window.get_decimal_point, lambda: (self.asset_requested.text()[:4] or decimal_point_to_base_unit_name(self.window.get_decimal_point())))
        ...
        msg = ''.join([
            ...
            _('The satori address never expires and will always be part of this electrum wallet.'), ' ',
            _('You can reuse an satori address any number of times but it is not good for your privacy.'),
            '\n\n',
        ...
        self.receive_tabs.addTab(self.receive_address_widget, read_QIcon("satori.png"), _('Address'))
