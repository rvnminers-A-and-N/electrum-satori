...
class SATAmountEdit(AmountEdit):
...
class FeerateEdit(SATAmountEdit):
    ...
    def get_amount(self):
        sat_per_byte_amount = SATAmountEdit.get_amount(self)
