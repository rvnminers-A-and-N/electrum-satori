...
from .util import format_satoshis, format_fee_satoshis, SatoriValue
...
class SimpleConfig(Logger):
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'sat': 8}  # , 'mbtc':5, 'ubtc':2, 'bits':2, 'sat':0}
