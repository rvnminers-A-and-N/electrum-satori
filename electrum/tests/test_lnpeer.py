...
from electrum.satori import COIN, sha256
...
high_fee_channel = {
   'local_balance_msat': 10 * satori.COIN * 1000 // 2,
   'remote_balance_msat': 10 * satori.COIN * 1000 // 2,
...
class TestPeer(TestCaseForTestnet):
    ...
    def test_close_upfront_shutdown_script(self):
        ...
        bob_uss_addr = satori.pubkey_to_address('p2wpkh', bh2u(bob_uss_pub))
        bob_uss = bfh(satori.address_to_script(bob_uss_addr))
