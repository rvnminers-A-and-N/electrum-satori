...
title = Electrum-Satori

# (str) Package name
package.name = Electrum_Satori

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum-satori
...
android.add_activities = org.electrum-satori.qr.SimpleScannerActivity
